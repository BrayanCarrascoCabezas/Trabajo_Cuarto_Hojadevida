...
public class Exp_ProfecionalImpl implements IExp_Profecional {
    ...
    public int insertar(Exp_Profecional exp_profecional) throws Exception {
        ...
        lstPar.add(new Parametro(2, exp_profecional.getCodigoE()));
        lstPar.add(new Parametro(3, exp_profecional.getEmpresa_institucion()));
    ...
    public Exp_Profecional obtener(int codigoExp) throws Exception {
        ...
        try {
            ...
            while (rst.next()) {
                ...
                exp_profecional.setCodigoE(rst.getInt(2));
                exp_profecional.setEmpresa_institucion(rst.getString(3));
